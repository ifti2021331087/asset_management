...
--> statement-breakpoint
ALTER TABLE "asset" ALTER COLUMN "file_url" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "asset" ALTER COLUMN "is_approved" SET DEFAULT 'pending';--> statement-breakpoint
ALTER TABLE "asset" ALTER COLUMN "is_approved" SET NOT NULL;--> statement-breakpoint
